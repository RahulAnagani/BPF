...
const ProfileCard = () => {
  ...
  Build fast, think deeply, design beautifully.
      ...
      <div className="card-socials">
        <a href='https://github.com/RahulAnagani/' target='_blank' className="card-socials-btn github" aria-label="GitHub">
          <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24">
            <path d="M12 0c-6.626 0-12 5.373-12 12 
              ...
              0-6.627-5.373-12-12-12z"></path>
          </svg>
        </a>

        <a href='https://www.linkedin.com/in/rahul-anagani-82b1ab299' target='_blank' className="card-socials-btn linkedin" aria-label="LinkedIn">
          <svg xmlns="http://www.w3.org/2000/svg" height="32" viewBox="0 0 512 512" width="32">
            <path d="M51.326 185.85h90.011v270.872h-90.011zm45.608-130.572c-30.807 0-50.934 
              20.225-50.934 46.771 0 26 19.538 46.813 49.756 46.813h.574c31.396 0 
              50.948-20.814 50.948-46.813-.589-26.546-19.551-46.771-50.344-46.771zm265.405 
              124.209c-47.779 0-69.184 26.28-81.125 44.71v-38.347h-90.038c1.192 
              25.411 0 270.872 0 270.872h90.038v-151.274c0-8.102.589-16.174 
              2.958-21.978 6.519-16.174 21.333-32.923 
              46.182-32.923 32.602 0 45.622 24.851 
              45.622 61.248v144.926h90.024v-155.323c0-83.199-44.402-121.911-103.661-121.911z"></path>
          </svg>
        </a>
      </div>
    </div>
